...
export const WorkflowNodes: React.FC = () => {
  ...
  return (
    <motion.div
      ref={ref}
      className="relative h-[700px] max-w-6xl mx-auto"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
        ...
        <defs>
          {nodes.map((_, index) => (
            ...
            >
              <stop
                offset="0%"
                stopColor={`rgb(${59 + index * 30}, 130, 246)`}
              />
              <stop
                offset="100%"
                stopColor={`rgb(147, ${51 + index * 30}, 234)`}
              />
            </linearGradient>
          ))}
          <filter id="glow">
      ...
      {nodes.map((node, index) => (
        ...
        >
          <Card
            className={`
              relative overflow-hidden backdrop-blur-sm border p-4 w-52
          ...
          >
            <motion.div
              ...
              initial={false}
              animate={{
                opacity: activeNodeIndex === index ? 0.1 : 0,
            ...
            <div className="relative flex items-start gap-4">
              <motion.div
                ...
                `}
                animate={{
                  scale: activeNodeIndex === index ? [1, 1.1, 1] : 1,
                }}
                transition={{
                  duration: 0.5,
                  ease: "easeInOut",
              ...
              <div className="flex flex-col gap-1">
                <motion.h3
                  ...
                  animate={{
                    opacity: activeNodeIndex === index ? 1 : 0.7,
                  }}
                >
                  {node.title}
                </motion.h3>
                <motion.p
                  ...
                  animate={{
                    opacity: activeNodeIndex === index ? 0.8 : 0.5,
                  }}
                >
                  {node.description}
                </motion.p>
            ...
            <motion.div
              ...
              animate={{
                opacity: activeNodeIndex === index ? 0.5 : 0.2,
              }}
            />
          </Card>
        </motion.div>
